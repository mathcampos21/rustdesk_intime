    ...
    final settings = SettingsList(
      sections: [
        ...
        SettingsSection(title: Text(translate("Settings")), tiles: [
          // --- FASE 2: BLOQUEIO DE UI (MOBILE) - INICIO ---
          // Comentamos o acesso ao ID/Relay Server para o usuário não alterar
          /*
          ...
          */
          ...
          // Comentamos o acesso ao WebSocket
          /*
          ...
          */
          // --- FASE 2: BLOQUEIO DE UI (MOBILE) - FIM ---
