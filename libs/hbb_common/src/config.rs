...
pub const RS_PUB_KEY: &str = "AME0EziTTHAL3G9wcmjg926szUlpaWIhxBLbidlGF0s=";
...
impl Config {
    ...
    pub fn get_rendezvous_server() -> String {
        // FASE 1: Hardcoding - Retorna SEMPRE o seu servidor
        // Pode ser IP (ex: "192.168.1.50") ou Domínio (ex: "rust.meudominio.com")
        // Não é obrigatório colocar a porta se for a padrão 21116, mas ajuda a ser explícito.
        "rust.intimelab.com.br".to_owned()
    }
...
impl PeerConfig {
    ...
    fn default_options() -> HashMap<String, String> {
        ...
        // FASE 1: Hardcoding - Forçar Relay Server (porta padrão 21117)
        mp.insert("relay-server".to_owned(), "rust.intimelab.com.br:21117".to_owned());
        mp.insert("api-server".to_owned(), "http://rust.intimelab.com.br:21114".to_owned()); // Se usar API
